...
contract TransparentProxy {
    ...
    constructor(address implementation1) {
        ...
        _admin = msg.sender;
        _implementation = implementation1;
    }

    /**
     * @dev  fallback函数，将所有非管理员调用转发给逻辑合约
     */
    ...
    function upgradeTo(address newImplementation) external {
        require(msg.sender == _admin, "just admin can do");
        require(newImplementation != address(0), "newImplementation  zero");
        require(newImplementation != _implementation, "newImplementation == _implementation");
